...
class _$ContactTearOff {
  ...
  _Contact call(
      {required String name, required String surename, required String email}) {
    return _Contact(
      name: name,
      surename: surename,
      email: email,
...
abstract class $ContactCopyWith<$Res> {
  ...
  $Res call({String name, String surename, String email});
}
    ...
    return _then(_value.copyWith(
      name: name == freezed
          ...
          : name // ignore: cast_nullable_to_non_nullable
              as String,
      surename: surename == freezed
          ? _value.surename
          : surename // ignore: cast_nullable_to_non_nullable
              as String,
      email: email == freezed
          ? _value.email
...
class _$_Contact implements _Contact {
  const _$_Contact(
      {required this.name, required this.surename, required this.email});
  ...
  @override
  String toString() {
    return 'Contact(name: $name, surename: $surename, email: $email)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.surename, surename) &&
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(surename),
...
abstract class _Contact implements Contact {
  const factory _Contact(
      ...
      required String email}) = _$_Contact;
